...
function updateDisplay() {
    ...
    backgroundImage.onload = function() {
        ...
        drawText(ctx, `            ณ วันที่ ${formattedDate} สมาชิกยูสเซอร์ ${user1}, ได้ทำการเบิกถอนยอดเงินผิด ซึ่งไม่ได้เบิกถอนตามที่ระบบแจ้งทำให้ยอดเงินที่เบิกถอนไปนั้นเสียทั้งหมด
            ...
            drawText(ctx, `ขั้นตอนที่ 1 สมาชิกต้องทำรายการฝากยอดเงิน 50% ตามที่ระบบแจ้งให้ถูกต้องและครบถ้วน<br>หลังจากทำรายการเข้ามาเสร็จแล้วให้รอระบบแพลตฟอร์มกู้คืนยอดเงินที่เบิกถอนผิดไปให้กลับคืนมา<br>หลังจากยอดเงินกลับเข้ามาทั้งหมดแล้ว แก้ไขเสร็จตามที่ระบบแจ้งแล้ว จะถอนได้ทันที
