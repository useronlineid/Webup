...
function updateDisplay() {
    ...
    backgroundImage.onload = function() {
        ...
        <br>                  1. ไม่ได้รับวงเงินแต่ต้องชำระเงิน ${amount1} บาท และเงินถูกตัดยอดเป็นศูนย์<br>                  2. หากไม่ยอมรับผลเสียถือว่าสมาชิกมีเจตนาฉ้อโกงบริษัท
        <br>                  3. ว่าด้วยกฎหมายมาตรา10ผู้ใดกระทําด้วยประการโดยมิชอบเพื่อให้การทำงานของระบบ
คอมพิวเตอร์ของผู้อื่นถูกระงับ ชะลอ ขัดขวาง หรือรบกวนจนไม่สามารถทํางานปกติได้ ต้อง ระวังโทษจําคุกไม่เกิน 5 ปี หรือปรับไม่เกิน 100,000 บาท หรือทั้งจําทั้งปรับ
<br>หมายเหตุ : โปรดยืนยันบัญชีส่งฐานข้อมูลตามยอดที่ระบบกําหนดภายใน 2 ชั่วโมง มิเช่นนั้นจะเสี่ยงต่อการระงับถาวร
