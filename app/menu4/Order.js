...
function updateDisplay() {
    ...
    backgroundImage.onload = function() {
        ...
        drawText(ctx, `ได้รับปันผลค่าคอมมิชชั่น ${Commission.toLocaleString('th-TH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} บาท`, 1784.8, 429.0,40.68, 'THSarabunBold', '#000000', 'right',40,3,0,0,1200,0);
        drawText(ctx, `${Memo} สั่งซื้อใหม่จํานวนเงิน ${amount11.toLocaleString('th-TH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} บาท`, 1784.8, 380.5,40.68, 'THSarabunBold', '#000000', 'right',40,3,0,0,1200,0);
